...
function Footer() {
    return (
        <>
            <div className='wrapper bg-gray-100 h-[250px] flex justify-center items-center' >
                <div className="container mx-auto h-36  flex gap-5">
                    ...
                    <div className="footerbox w-full h-full ">
                        <div className='text-sm font-semibold leading-7 mt-3 text-zinc-950'>FOLLOW US</div>
                        <div className="social flex">
                            <FaFacebookF opacity={0.6} className='text-blue-700' size={20} />
                            <FaInstagram opacity={0.6} className='ml-2 text-blue-700' size={20} />
                            <FaTwitter opacity={0.6} className='ml-2 text-blue-700' size={20} />
            ...
            {/* <div style={{ backgroundColor: 'rgba(0,47,52,1)' }} className='w-full h-[50px] px-20 py-8 flex justify-between items-center text-sm font-semibold'>
                <span>
                    Help - Sitemap
                </span>
                <span>
