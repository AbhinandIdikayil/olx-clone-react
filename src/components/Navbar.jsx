...
function Navbar() {
    ...
    return (
        <div style={{ height: '72px' ,zIndex:999}} className='fixed w-full px-5 bg-gray-200 border-b-4 border-white flex items-center justify-between sm:justify-start gap-4 shadow-sm'>
            <div>
